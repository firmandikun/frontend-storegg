        ...
        <div className="text-center">
            <svg className="img-fluid"
                ...
                <g clip-path="url(#clip0)">
                    <path d="M263.96 271.587C264.986 271.07 265.5 270.554 266.525 270.037"
                        stroke="#FF78B7"
                        stroke-width="0.6123"
                    ...
                    <path d="M163.407 187.897C164.433 187.897 165.46 187.897 166.486 187.897"
                          stroke="#FF78B7"
                        stroke-width="0.6123"
                        stroke-linecap="round"
                        stroke-linejoin="round" />
                    <path d="M30.5337 294.317H334.245"
                          stroke="#B1B9CC"
                          stroke-width="2"
                          stroke-miterlimit="10"
                        stroke-linecap="round"
                        stroke-linejoin="round" />
                    <path d="M2.8302 294.317H15.1428"
                          stroke="#B1B9CC"
                          stroke-width="2"
                          stroke-miterlimit="10"
                        stroke-linecap="round"
